 ...
 * @package Vdm\Bundle\LibraryDoctrineOdmTransportBundle\DependencyInjection\Compiler
 */
class DoctrineExecutorCompilerPass implements CompilerPassInterface
{
    ...
    public function process(ContainerBuilder $container)
    {
        ...
        $taggedServices = $container->findTaggedServiceIds('vdm_library.doctrine_odm_executor');
